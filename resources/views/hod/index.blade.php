...
<div class="card">
    ...
    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-highlight">
            <li class="nav-item"><a href="#all-classRoom" class="nav-link active" data-toggle="tab">Manager Hod</a></li>
            @if(Qs::userIsAcademic()) <li class="nav-item">
                <a href="#new-classRoom" class="nav-link" data-toggle="tab">
                    <i class="icon-plus2"></i> Register HOD</a></li>@endif
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="new-classRoom">
                ...
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('academic.hod.create') }}">
                        @csrf

                        <div class="form-group row">
                            <label for="name" class="col-lg-3 col-form-label text-md-right">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-lg-3 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <option  {{ old('department') ?'selected' : '' }} value="{{ $department->id }}">{{ $department->abbr }}</option>
                                         @endforeach
                                    </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input id="password-confirm" hidden value="password" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-lg-6 offset-lg-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Register HOD') }} <i class="icon-user-plus ml-2"></i>
                                </button>
